...
public class BaseActivity extends AppCompatActivity implements Bye {
    ...
    public static final String[] PERMISSION_TAKE_PICTURE_30 = {"android.permission.READ_MEDIA_IMAGES", "android.permission.CAMERA"};
    public static final String[] PERMISSION_TAKE_VIDEO_30 = {"android.permission.READ_MEDIA_AUDIO", "android.permission.READ_MEDIA_VIDEO", "android.permission.CAMERA", "android.permission.RECORD_AUDIO"};
    public static final String[] PERMISSION_STORAGE_30 = {"android.permission.READ_MEDIA_IMAGES", "android.permission.READ_MEDIA_AUDIO", "android.permission.READ_MEDIA_VIDEO",};
